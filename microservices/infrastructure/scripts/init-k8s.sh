...
# Service Discovery
kubectl apply -f ./k8s/service-discovery/service-discovery-namespace.yaml
...
# Api Gateway
kubectl apply -f ./k8s/api-gateway/api-gateway-namespace.yaml
...
# Auth Service
kubectl apply -f ./k8s/auth-service/auth-service-namespace.yaml
...
# Gyms Service
kubectl apply -f ./k8s/gyms-service/gyms-service-namespace.yaml
...
# Memberships Service
kubectl apply -f ./k8s/memberships-service/memberships-service-namespace.yaml
