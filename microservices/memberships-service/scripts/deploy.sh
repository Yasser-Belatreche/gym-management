...
sed -i "s/gym-management-memberships-service:.*/gym-management-memberships-service:$1/g" microservices/infrastructure/k8s/memberships-service/memberships-service.yaml
